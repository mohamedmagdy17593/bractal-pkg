...
import ExternalLink from '~/coreUI/components/basic/ExternalLink';
import { Image } from 'semantic-ui-react';
import styled from '@emotion/styled';
import PropTypes from 'prop-types';
import ValidateAndResolve from '~/core/utils/jsHelpers/ValidateAndResolve';
import Separator from '~/coreUI/components/layouts/helpers/Separator';
